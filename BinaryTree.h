...
public:
	...
	void RemoveLeafNode(TreeNode* pCurrent, TreeNode* pParent);
	void RemoveNodeSingleLeft(TreeNode* pCurrent, TreeNode* pParent);
	void RemoveNodeSingleRight(TreeNode* pCurrent, TreeNode* pParent);
